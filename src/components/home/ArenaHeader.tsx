...
export default function ArenaHeader({ onOpenMenu, ticketCount = 0 }: { onOpenMenu: () => void, ticketCount?: number }) {
  ...
  // Auto-fetch unread notifications when the header mounts
  useEffect(() => {
  ...
  return (
    <View style={styles.header}>
      ...
      <View style={styles.headerRight}>
        ...
        {/* ✅ Updated to navigate to our newly moved Notifications screen */}
        <TouchableOpacity 
...
const styles = StyleSheet.create({
  ...
  badge: {
    ...
    paddingHorizontal: 4,
    borderWidth: 1.5,
    borderColor: '#0f0f13' // Creates a neat cutout effect against the background
  },
  badgeText: {
    color: '#fff',
    fontSize: 9,
