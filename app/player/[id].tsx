      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
          ...
          <View style={styles.heroCard}>
            ...
            <Text style={styles.heroGamerTag}>
                {pData.teamName || pData.gamerTag || playerData.name || 'Unknown Player'}
            </Text>
            <Text style={styles.heroName}>{playerData.name || ''}</Text>
            
            <View style={styles.leaguePill}>
              <Text style={styles.leaguePillText}>{lStats.leagueName || 'Unranked'}</Text>
            </View>
          </View>
          ...
          <View style={styles.statsGrid}>
            ...
            <View style={styles.statSquare}>
              ...
              <Text style={[styles.statValue, { color: '#38bdf8' }]}>
                {lStats.goalDifference ? (lStats.goalDifference > 0 ? `+${lStats.goalDifference}` : lStats.goalDifference) : 0}
              </Text>
            </View>
            <View style={styles.statSquare}>
